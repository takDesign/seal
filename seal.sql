...
CREATE TABLE `suggestions` (
  ...
  `strContent` longtext,
  `dPosted` datetime DEFAULT NULL,
  `nUsersID` mediumint(50) DEFAULT NULL
...
(18, 'Test', 'Test from Cpanel', '2019-08-17 00:00:00', 1),
(19, 'Suggestion', 'TestTestTestTestTestTest', '2019-08-17 00:00:00', 25),
(20, '6666666', '66666666', '2019-08-19 00:00:00', 1),
...
CREATE TABLE `users` (
  ...
  `strAvatarName` varchar(255) DEFAULT NULL,
  `nPoints` tinyint(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
